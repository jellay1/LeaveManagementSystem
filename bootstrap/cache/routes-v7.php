...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::tRks7aDNR2bLNhT2',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::XG7875JjFUaoi1ZE',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/reset\\-password/([^/]++)(*:32)|/notifications/(?|([^/]++)(?|/read(*:73)|(*:80))|clear\\-read(*:99))|/manager\\-dashboard/(?|approve/([^/]++)(*:146)|reject/([^/]++)(*:169))|/employees/([^/]++)(?|(*:200)|/edit(*:213)|(*:221))|/leave\\-(?|types/([^/]++)(?|(*:258)|/edit(*:271)|(*:279))|requests/([^/]++)(?|(*:308)|/edit(*:321)|(*:329)))|/storage/(.*)(?|(*:355)))/?$}sDu',
    ),
    3 => 
    array (
      32 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'notifications.clear-read',
          ),
          1 => 
          array (
          ),
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'manager-dashboard.approve',
          ),
          1 => 
          array (
            0 => 'leaveRequest',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'manager-dashboard.reject',
          ),
          1 => 
          array (
            0 => 'leaveRequest',
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:1137:"function (\\Illuminate\\Http\\Request $request) {
                    ...
                    return response(\\Illuminate\\Support\\Facades\\View::file(\'C:\\\\SPEC6_Project\\\\LeaveManagement\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Foundation\\\\Configuration\'.\'/../resources/health-up.blade.php\', [
                        \'exception\' => $exception,
                    ]), status: $status);
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\NotificationController@clearRead',
        'controller' => 'App\\Http\\Controllers\\NotificationController@clearRead',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'notifications.clear-read',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'manager-dashboard/approve/{leaveRequest}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ManagerDashboardController@approve',
        'controller' => 'App\\Http\\Controllers\\ManagerDashboardController@approve',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'manager-dashboard.approve',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    'manager-dashboard.reject' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'manager-dashboard/reject/{leaveRequest}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ManagerDashboardController@reject',
        'controller' => 'App\\Http\\Controllers\\ManagerDashboardController@reject',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'manager-dashboard.reject',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'leave-requests/{leave_request}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'leave-requests/{leave_request}/edit',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LeaveRequestController@approvals',
        'controller' => 'App\\Http\\Controllers\\LeaveRequestController@approvals',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ReportController@exportCsv',
        'controller' => 'App\\Http\\Controllers\\ReportController@exportCsv',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'reports.export-csv',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'action' => 
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:52:"C:\\SPEC6_Project\\LeaveManagement\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:323:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                    return (new \\Illuminate\\Filesystem\\ServeFile(
                        $disk,
                        $config,
                        $isProduction
                    ))($request, $path);
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"00000000000006670000000000000000";}}',
        'as' => 'storage.local',
      ),
      'fallback' => false,
      'defaults' => 
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:52:"C:\\SPEC6_Project\\LeaveManagement\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:325:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"00000000000006950000000000000000";}}',
